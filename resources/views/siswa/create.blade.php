                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('siswa.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nama_siswa" type="text" class="form-control{{ $errors->has('nama_siswa') ? ' is-invalid' : '' }}" name="nama_siswa" value="{{ old('nama_siswa') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="alamat_siswa" type="text" class="form-control{{ $errors->has('alamat_siswa') ? ' is-invalid' : '' }}" name="alamat_siswa" value="{{ old('alamat_siswa') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="hobi_siswa" type="text" class="form-control" name="hobi_siswa" required>
                                @if ($errors->has('hobi'))
                                    <span class="invalid-feedback" role="alert">
